...
\begin{table}[H]
  ...
  \begin{minipage}{\textwidth}
    Notes. The dependent variable is excess return at $t+1$ in decimal form. All models use the same 230 firms. Standard errors are in parentheses. Column (g) uses HC1 firm-clustered standard errors and 229 degrees of freedom for $t$-tests. $^{*}p<0.10$, $^{**}p<0.05$, $^{***}p<0.01$.
  \end{minipage}
\end{table}
